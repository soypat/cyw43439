...
const (
	...
	// current AP's TSF value went backwar
	EvRETROGRADE_TSF AsyncEventType = 22
	// AP was pruned from join list for reaso
	EvPRUNE AsyncEventType = 23
	// report AutoAuth table entry match for join attemp
	EvAUTOAUTH AsyncEventType = 24
	// Event encapsulating an EAPOL messag
	EvEAPOL_MSG AsyncEventType = 25
	// Scan results are ready or scan was aborte
	EvSCAN_COMPLETE AsyncEventType = 26
	// indicate to host addts fail/succes
	EvADDTS_IND AsyncEventType = 27
	// indicate to host delts fail/succes
	EvDELTS_IND AsyncEventType = 28
	// indicate to host of beacon transmi
	...
	// before attempting to roa
	EvROAM_PREP AsyncEventType = 32
	// PFN network found even
	EvPFN_NET_FOUND AsyncEventType = 33
	// PFN network lost even
	...
	// PFN best network batching even
	...
	// assoc request receive
	EvPRE_ASSOC_IND AsyncEventType = 61
	// re-assoc request receive
	...
	// probe response receive
	EvPROBRESP_MSG AsyncEventType = 71
	// P2P Probe request receive
	...
	// authentication request receive
	...
	// AWDL Master/Slave/NE master role even
	...
	// Proximity Detection even
	EvPROXD AsyncEventType = 109
	// AWDL RX Probe respons
	...
	// to report change in BSSID while roamin
	...
	// psta primary interface indicatio
	...
	// FBT Authentication Request Indicatio
	...
	// Significant change in rssi of bssids being tracke
